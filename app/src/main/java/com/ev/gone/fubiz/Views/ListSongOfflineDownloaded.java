...
public class ListSongOfflineDownloaded extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        startActivity(new Intent(getApplicationContext(), AlphaActivityOnline.class).putExtra("pos", i).putExtra("song_list", mySongs));
                    }
                });
