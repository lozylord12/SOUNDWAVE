...
public class AlphaSettingActivityOnline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data_adapter_test = new ListViewAdapter(AlphaSettingActivityOnline.this, ListSong);
        ...
        lvsong.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    Intent myIntent = new Intent(view.getContext(), AlphaActivityOnline.class);
        ...
        backto_alpha_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent redirect_one = new Intent(AlphaSettingActivityOnline.this, AlphaActivityOnline.class);
